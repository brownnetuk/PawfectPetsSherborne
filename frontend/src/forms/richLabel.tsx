...
// Used for any FormField.label (types.ts), authored via the Bold/Underline
// buttons next to admin's FormBuilder label editor -- mirrors
// admin/src/utils/richLabel.tsx exactly (no shared package between the two
// apps).
