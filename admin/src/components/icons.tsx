...
// A simple dog-kennel silhouette (pentagon house shape + round entrance) --
// distinct from BookingsIcon's calendar grid and FinancialIcon's house/bars,
// since this nav item is specifically about boarding/day-care stays.
export function BoardingIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 21V11L12 4l9 7v10" />
      <path d="M3 21h18" />
...
export function ReportsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="13" y="7" width="3" height="14" />
...
// Sent-and-opened counterpart to MailIcon (a closed envelope) -- used
// side by side so the two read/unread states are visually distinct at a
// glance rather than stacking a separate "Read" badge under the status.
