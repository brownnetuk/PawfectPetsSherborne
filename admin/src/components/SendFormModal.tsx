...
import type { Customer, FormRecord } from '../types';
...
export default function SendFormModal({ form, customer, onClose }: Props) {
  ...
  async function sendEmail() {
    ...
    setSendResult(null);
    try {
      await api.sendTriggeredEmail('form', email, name || email, link);
